...
Copaste is a Cities: Skylines II mod: a copy & paste tool for props (props, decals and
trees). This folder documents how the code works, module by module, including the
non-obvious constraints of the game's modding surface that shaped the design.
...
src/
  ...
  Localization.cs      — English and Serbian dictionaries for the Options screen
ui/
